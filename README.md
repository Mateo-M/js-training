[![Build Status](https://travis-ci.org/Mateo-M/js-training.svg?branch=master)](https://travis-ci.org/nan-academy/js-training)
## Setup
First, [**fork**](https://github.com/Mateo-M/js-training/fork?fragment=1) this repository.
